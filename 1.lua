...
-- EXPIRE DATE SYSTEM
-- ============================================
local EXPIRE_DATE = "2026-05-28" -- Change this date
...
-- NEW: Calculate days remaining function
...
function BRPlayerCharacterBase:StartAdvancedSystems()
    ...
    self:AddGameTimer(0.1, true, function()
        ...
        -- Skin system integration (outfits only)
