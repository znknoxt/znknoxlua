    ...
    if isEnabled then
        ...
        pcall(function()
            ...
            if mWh then
                ...
                -- GREEN when visible, YELLOW when behind walls
                local hiddenColor  = { R = 255.0, G = 255.0, B = 0.0,   A = 1.0, r = 255.0, g = 255.0, b = 0.0,   a = 1.0 }  -- YELLOW (behind walls)
                local visibleColor = { R = 0.0,   G = 255.0, B = 0.0,   A = 1.0, r = 0.0,   g = 255.0, b = 0.0,   a = 1.0 }  -- GREEN (visible)
...
function BRPlayerCharacterBase:ReceiveTick(DeltaTime)
    -- GREEN when visible, YELLOW when behind walls (BlendMode 2 = translucent through walls)
